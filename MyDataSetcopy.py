...
class MyDataSet(Dataset):
    ...
    def __init__(self, dataset_dir, mode="train", trans=None):
        ...
        self.image_dir = os.path.join(dataset_dir, "Images_100_min_max_normalize")
        self.label_dir = os.path.join(dataset_dir, "Labels_100")
        self.imagesets_dir = os.path.join(dataset_dir, "ImageSets_100")
        self.mode = mode
